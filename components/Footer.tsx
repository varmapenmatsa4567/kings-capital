            ...
            <div className="container mx-auto px-6 py-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm text-gray-400">
                            <li className="flex items-start">
                                ...
                                <span>5618 TENTH LINE W UNIT
                                    MISSISSAUGA, Ontario L5M7L9</span>
                            </li>
                            ...
                            <li className="flex items-center">
                                ...
                                <span>a.khalik@aarmancapital.com</span>
                            </li>
                            <li className="flex items-center">
                ...
                <div className="mt-10 pt-8 border-t border-gray-700 flex flex-col sm:flex-row justify-between items-center text-sm">
                    ...
                    <div className="flex space-x-4 mt-4 sm:mt-0">
                        <a className="text-gray-400 hover:text-white" target="_blank" href="https://www.facebook.com/list2maxrealty/">
                        ...
                        <a className="text-gray-400 hover:text-white" target="_blank" href="https://x.com/akhalik16?lang=en">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a className="text-gray-400 hover:text-white" target="_blank" href="https://www.linkedin.com/in/abdul-khalik-bb6890216/">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
