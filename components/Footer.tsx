            ...
            <div className="container mx-auto px-6 py-12">
                ...
                <div className="mt-10 pt-8 border-t border-gray-700 flex flex-col sm:flex-row justify-between items-center text-sm">
                    ...
                    <div className="flex space-x-4 mt-4 sm:mt-0">
                        <a className="text-gray-400 hover:text-white" href="https://www.facebook.com/list2maxrealty/">
                        ...
                        <a className="text-gray-400 hover:text-white" href="https://x.com/akhalik16?lang=en">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a className="text-gray-400 hover:text-white" href="https://www.linkedin.com/in/abdul-khalik-833279118/?trk=nav_responsive_tab_profile">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
